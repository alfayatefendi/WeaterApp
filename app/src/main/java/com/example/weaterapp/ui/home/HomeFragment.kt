...
import com.example.weaterapp.adapter.ListWeatherAdapter
import com.example.weaterapp.databinding.FragmentHomeBinding
import com.example.weaterapp.domain.model.weather.Forecast
import com.example.weaterapp.domain.model.weather.WeatherData
import com.example.weaterapp.ui.MainActivity
import com.example.weaterapp.utils.cleanZero
import com.example.weaterapp.utils.formaterTimeNow
import com.example.weaterapp.utils.formattedDate
import com.example.weaterapp.utils.getLocationName
import com.example.weaterapp.utils.resolveColorAttr
...
class HomeFragment : Fragment() {
    ...
    private lateinit var lisWeatherAdapter: ListWeatherAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        act = activity as MainActivity
        lisWeatherAdapter = ListWeatherAdapter()
    }
...
//                            setupShimmerLoading(false)
                            ...
                            lisWeatherAdapter.submitList(state.weatherInfo.forecastWeatherData.values.toList())
                        }
                    }
                }
            }
        ...
        binding.btnGrpForecastToday.addOnButtonCheckedListener { _, checkedId, isChecked ->
            if (isChecked)
                when (checkedId) {
                    ...
                    R.id.btn_hummidity -> weatherViewModel.forecast.value = Forecast.HUMIDITY
                }
        }
    }
    ...
    private fun setupCurrentWeather(weatherData: WeatherData) {
        ...
        binding.layoutCardCurrentWeather.apply {
            ...
            tvTemperature.text =
                getString(R.string.temp, weatherData.temperatureCelcius.toString().cleanZero())
        ...
        binding.menuFeelsLike.apply {
            ...
            tvUtilities.text =
                getString(R.string.temp, weatherData.feelsLikeCelcius.toString().cleanZero())
        }
    ...
    private fun setupLineChartForecast(
        ...
        val entry = weathers.map {
            Entry(
                ...
                when(forecast) {
                    Forecast.FEELS_LIKE -> it.temperatureCelcius.toFloat()
    ...
    private fun styleLineChart(lineChart: LineChart) = lineChart.apply {
        ...
        val timeValueFormatter = object : ValueFormatter() {
            ...
            override fun getFormattedValue(value: Float): String {
                ...
                return localTime.formaterTimeNow(requireContext())
            }
        }
        xAxis.apply {
            axisMinimum = 0f
            ...
            textColor = requireContext().resolveColorAttr(com.google.android.material.R.attr.colorOnSurface)
    ...
    private fun styleLineDataSet(lineDataSet: LineDataSet, forecast: Forecast) = lineDataSet.apply {
        ...
        valueTextColor = requireContext().resolveColorAttr(com.google.android.material.R.attr.colorOnSurface)
        valueTextSize = 12f
        ...
        setDrawFilled(true)
        fillDrawable = ContextCompat.getDrawable(requireContext(), R.drawable.shape_bg_filled_line_chart)
    }
